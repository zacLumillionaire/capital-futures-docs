...
"""
策略核心模組 - 包含所有可複用的回測組件
從 multi_Profit-Funded Risk_多口.py 提取的核心功能
"""
    ...
    try:
        ...
        with context_manager as (conn, cur):
            ...
            return {
                ...
                'daily_pnl_list': daily_pnl_list  # 🚀 【Task 1 新增】每日損益列表
            }
        ...
        return {
            ...
            'daily_pnl_list': []  # 🚀 【Task 1 新增】錯誤時回傳空列表
        }
