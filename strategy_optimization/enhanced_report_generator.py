...
def extract_trading_data_from_log(log_content: str) -> tuple:
    ...
    for line in lines:
        ...
        # 提取出場資訊
        elif ('✅' in line or '❌' in line or '🛡️' in line) and '損益:' in line:
            try:
                lot_counter += 1
...
def generate_enhanced_html_report(statistics: Dict[str, Any], chart_data: Dict[str, str], config_data: Dict[str, Any], strategy_summary: str = "", log_content: str = "") -> str:
    """生成增強版HTML報告"""
...
def generate_comprehensive_report(log_content: str, config_data: Dict[str, Any]) -> Optional[str]:
    ...
    try:
        ...
        html_content = generate_enhanced_html_report(statistics, chart_data, config_data, strategy_summary, log_content)
