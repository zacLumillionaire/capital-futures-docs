        ...
        <form id="backtestForm">
            ...
            <div class="section">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>第1口</td>
                            <td><input type="number" name="lot1_trigger" value="15" step="0.1" required></td>
                            <td><input type="number" name="lot1_trailing" value="20" step="0.1" required></td>
                            <td>N/A</td>
                        </tr>
                        <tr>
                            <td>第2口</td>
                            <td><input type="number" name="lot2_trigger" value="40" step="0.1" required></td>
                            <td><input type="number" name="lot2_trailing" value="20" step="0.1" required></td>
                            <td><input type="number" name="lot2_protection" value="2.0" step="0.1" required></td>
                        </tr>
                        <tr>
                            <td>第3口</td>
                            <td><input type="number" name="lot3_trigger" value="65" step="0.1" required></td>
                            <td><input type="number" name="lot3_trailing" value="20" step="0.1" required></td>
                            <td><input type="number" name="lot3_protection" value="2.0" step="0.1" required></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="section">
                ...
                <div class="checkbox-group">
                    ...
                    <label for="stop_loss_filter">停損策略濾網</label>
                </div>
